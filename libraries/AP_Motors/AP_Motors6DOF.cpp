...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    default:
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_1,    -2.0f,          -2.0f,              2.0f,           0,                  2.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     2.0f,          -2.0f,             -2.0f,           0,                  2.0f,               0,              2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,    -2.0f,          -2.0f,             -2.0f,           0,                  2.0f,               0,              3);
        add_motor_raw_6dof(AP_MOTORS_MOT_4,     2.0f,           2.0f,              2.0f,           0,                  2.0f,               0,              4);
        add_motor_raw_6dof(AP_MOTORS_MOT_5,     0,              0,                 0.2f,           2.0f,               0,                  0,              5);
        break;
